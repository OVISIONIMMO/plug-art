...
# Legacy model generation is disabled. The live dashboard uses only the
# isolated canonical V72 asset generated by app_extra_v59.
ANIMS=["Idle","SoftTurn","Think","Curious","Present","Bounce","Happy","Attentive","Wave","Dance","Blink"]
result={"animations":ANIMS,"nodes":0,"design":"legacy-disabled","body":False}
