...
if INDEX.exists():
    ...
    remove_names=(
        ...
        "plugy_v57_final.js","plugy_v58_visible.js","plugy_v59_polished.js","ui_v60_glass.js","ui_v61_signal.js",
    ...
    active=(
        ...
        "studio_v44_ai_director.js","studio_v44_editor.js","studio_v44_editor_bridge.js","studio_v44_pro.js",
        "studio_v44_canvas.js","studio_v44_export.js","studio_v44_layers.js","studio_v44_batch_export.js",
        "studio_v45_clean_ui.js","studio_v45_context_actions.js","plugy_v59_polished.js","ui_v61_signal.js"
    )
    scripts="\n".join(f'<script defer src="/static/{name}?v=61.20260919.1"></script>' for name in active)
    page=page.replace("</body>",scripts+"\n</body>",1)
    INDEX.write_text(page,encoding="utf-8")

print(f"PLUGY_V61_READY bytes={len(raw)} nodes={result.get('nodes')} animations={','.join(ANIMS)} sha256={digest}",flush=True)
...
@app.middleware("http")
async def v61_no_cache(request:Request,call_next):
    response=await call_next(request)
    p=request.url.path
    if p in ("/","/index.html","/static/PLUGY_final_animated.glb") or "plugy_v59_polished" in p or "ui_v61_signal" in p or "studio_v44_" in p or "studio_v45_" in p:
...
def v43_status():
    ...
    return {
        ...
        "ui_runtime":"ui_v61_signal.js" in page,
        "dashboard_ui":"signal-room",
