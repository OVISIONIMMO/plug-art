...
def root_v102(request:Request):
    ...
    headers={
      ...
      'ETag':etag,
      'X-Plug-Art-Version':'117.0',
      'X-Plug-Art-UI':'plug-art-v117-compact-cockpit'
    }
...
def status_v90():
    ...
    return {
      ...
      'version':'117.0',
      'ui':'plug-art-v117-compact-cockpit',
      'reference_direction':'V117 PLUG ART: compact internal work cockpit with full-width quick command bar, Today focus, unified resume panel, priority Open Calls, context-aware PLUGY operator, continuous voice, Instagram Studio and mobile-first workflows',
