...
def root_v102(request:Request):
    ...
    headers={
      ...
      'ETag':etag,
      'X-Plug-Art-Version':'110.0',
      'X-Plug-Art-UI':'plug-art-v110-fast-resilient-workspace'
    }
...
def status_v90():
    ...
    return {
      ...
      'version':'110.0',
      'ui':'plug-art-v110-fast-resilient-workspace',
      'reference_direction':'V110 PLUG ART: fast resilient internal workspace with progressive bootstrap, lazy secondary views, on-demand 3D PLUGY, autosave, network recovery, Radar workflow, Agenda, Bureau, CRM and Creation',
