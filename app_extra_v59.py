...
def root_v102(request:Request):
    ...
    headers={
      ...
      'ETag':etag,
      'X-Plug-Art-Version':'111.0',
      'X-Plug-Art-UI':'plug-art-v111-fast-mobile-workspace'
    }
...
def status_v90():
    ...
    return {
      ...
      'version':'111.0',
      'ui':'plug-art-v111-fast-mobile-workspace',
      'reference_direction':'V111 PLUG ART: touch-first mobile productivity workspace with progressive bootstrap, lazy secondary views, on-demand 3D PLUGY, resilient voice, autosave, network recovery, Radar, Open Calls, Agenda, Bureau, CRM and Creation',
