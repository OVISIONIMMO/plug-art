...
def root_v102(request:Request):
    ...
    headers={
      ...
      'ETag':etag,
      'X-Plug-Art-Version':'116.0',
      'X-Plug-Art-UI':'plug-art-v116-operator-workspace'
    }
...
def status_v90():
    ...
    return {
      ...
      'version':'116.0',
      'ui':'plug-art-v116-operator-workspace',
      'reference_direction':'V116 PLUG ART: premium internal workspace with context-aware PLUGY operator actions, entity-aware AI context, optional continuous voice conversation, Instagram publishing, modular data and mobile-first workflows',
