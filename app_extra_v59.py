...
def root_v102(request:Request):
    ...
    headers={
      ...
      'ETag':etag,
      'X-Plug-Art-Version':'108.0',
      'X-Plug-Art-UI':'plug-art-v108-internal-studio'
    }
...
def status_v90():
    ...
    return {
      ...
      'version':'108.0',
      'ui':'plug-art-v108-internal-studio',
      'reference_direction':'V108 PLUG ART: compact internal dashboard, direct Radar and Open Call workflow, persistent Bureau, CRM prospection, carousel and visual studio, and one realistic contextual PLUGY',
