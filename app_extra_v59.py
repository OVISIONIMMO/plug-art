...
def root_v102(request:Request):
    ...
    headers={
      ...
      'ETag':etag,
      'X-Plug-Art-Version':'109.0',
      'X-Plug-Art-UI':'plug-art-v109-productivity-workspace'
    }
...
def status_v90():
    ...
    return {
      ...
      'version':'109.0',
      'ui':'plug-art-v109-productivity-workspace',
      'reference_direction':'V109 PLUG ART: compact productivity workspace with Radar presets, Open Call favorites and workflow, Agenda, persistent Bureau and drafts, CRM prospection, creation studio and interactive voice PLUGY',
