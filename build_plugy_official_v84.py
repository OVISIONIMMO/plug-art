...
def build_plugy_official_v84(output_path: str | Path):
    ...
    eye = tube_chevron(width=.344, height=.132, radius=.052, segments=24, sides=22)
    meshes.append(("EyeL", eye, 1))
    meshes.append(("EyeR", eye.copy(), 1))

    # V26 edge-light signature, but now much finer and less strip-like.
    rim_v = superellipsoid(.010, .355, .010, e1=2.0, e2=2.0, n_lat=12, n_lon=22)
    meshes.append(("RimCyan", rim_v, 2))
    meshes.append(("RimViolet", rim_v.copy(), 3))
    rim_h = superellipsoid(.33, .010, .012, e1=2.0, e2=2.0, n_lat=10, n_lon=30)
    meshes.append(("RimBottomCyan", rim_h, 2))
    meshes.append(("RimBottomViolet", rim_h.copy(), 3))

    materials = [
        {
            "name": "PLUGY Pearl White Rose Iridescent",
            "pbrMetallicRoughness": {
                "baseColorFactor": [.955, .895, .965, 1.0],
                "metallicFactor": .025,
                "roughnessFactor": .070,
            },
            "extensions": {
                "KHR_materials_clearcoat": {"clearcoatFactor": 1.0, "clearcoatRoughnessFactor": .016},
                "KHR_materials_specular": {"specularFactor": 1.0, "specularColorFactor": [1.0, .975, 1.0]},
                "KHR_materials_iridescence": {
                    "iridescenceFactor": .68,
                    "iridescenceIor": 1.30,
                    "iridescenceThicknessMinimum": 170.0,
                    "iridescenceThicknessMaximum": 460.0
                },
                "KHR_materials_ior": {"ior": 1.46},
                "KHR_materials_transmission": {"transmissionFactor": .035},
                "KHR_materials_volume": {
                    "thicknessFactor": .10,
                    "attenuationDistance": 3.0,
                    "attenuationColor": [1.0, .90, .98]
                }
            },
        },
        {
            "name": "PLUGY Black Indigo Eyes",
            "pbrMetallicRoughness": {
                "baseColorFactor": [.004, .003, .010, 1.0],
                "metallicFactor": .015,
                "roughnessFactor": .055,
            },
            "extensions": {
                "KHR_materials_clearcoat": {"clearcoatFactor": .98, "clearcoatRoughnessFactor": .018},
                "KHR_materials_specular": {"specularFactor": .98, "specularColorFactor": [.74, .70, 1.0]},
        ...
        },
        {
            ...
            "pbrMetallicRoughness": {
                "baseColorFactor": [.42, .76, 1.0, .045],
                "metallicFactor": 0.0,
                "roughnessFactor": .20,
            },
            "emissiveFactor": [.002, .006, .010],
            "alphaMode": "BLEND",
            "extensions": {"KHR_materials_emissive_strength": {"emissiveStrength": .06}},
        },
        {
            "name": "Soft Violet Reflection",
            "pbrMetallicRoughness": {
                "baseColorFactor": [.68, .38, .95, .055],
                "metallicFactor": 0.0,
                "roughnessFactor": .20,
            },
            "emissiveFactor": [.006, .002, .012],
            "alphaMode": "BLEND",
            "extensions": {"KHR_materials_emissive_strength": {"emissiveStrength": .07}},
        },
    ]
    ...
    nodes = [
        ...
        {"name": "Body", "mesh": 0},
        {"name": "Prong_L", "mesh": 1, "translation": [-.285, .835, -.010], "rotation": [0.0, 0.0, -.018, .99984]},
        {"name": "Prong_R", "mesh": 2, "translation": [.285, .835, -.010], "rotation": [0.0, 0.0, .018, .99984]},
        {"name": "ProngBlend_L", "mesh": 3, "translation": [-.285, .635, -.006]},
        {"name": "ProngBlend_R", "mesh": 4, "translation": [.285, .635, -.006]},
        {"name": "Eye_L", "mesh": 5, "translation": [-.278, -.010, .256]},
        {"name": "Eye_R", "mesh": 6, "translation": [.278, -.010, .256]},
        {"name": "Rim_Cyan", "mesh": 7, "translation": [-.838, -.010, .220]},
        {"name": "Rim_Violet", "mesh": 8, "translation": [.838, -.010, .220]},
        {"name": "Rim_Bottom_Cyan", "mesh": 9, "translation": [-.345, -.668, .220]},
        {"name": "Rim_Bottom_Violet", "mesh": 10, "translation": [.345, -.668, .220]},
    ]
    ...
    gltf = {
        "asset": {"version": "2.0", "generator": "PLUG ART · PLUGY Official V84"},
        "scene": 0,
    ...
    return {
        ...
        "material": "pearl-white-rose-iridescent-black-indigo-eyes",
        "official_base": "V26",
        "profile": "master-strict-square-rounded-flat-face-integrated-prongs",
    }


if __name__ == "__main__":
    print(build_plugy_official_v84(Path(__file__).resolve().parent / "static" / "plugy_official_v84.glb"))
