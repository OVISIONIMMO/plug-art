...
def build_plugy_official_v81(output_path: str | Path):
    ...
    materials = [
        {
            "name": "PLUGY Rose Lavender Iridescent",
            "pbrMetallicRoughness": {
                "baseColorFactor": [.965, .57, .86, 1.0],
                "metallicFactor": .045,
                "roughnessFactor": .075,
            },
            "extensions": {
                "KHR_materials_clearcoat": {"clearcoatFactor": 1.0, "clearcoatRoughnessFactor": .018},
                "KHR_materials_specular": {"specularFactor": 1.0, "specularColorFactor": [1.0, .90, .98]},
                "KHR_materials_iridescence": {
                    "iridescenceFactor": .82,
                    "iridescenceIor": 1.30,
        ...
        {
            "name": "PLUGY Plum Violet Eyes",
            "pbrMetallicRoughness": {
                "baseColorFactor": [.065, .025, .11, 1.0],
                "metallicFactor": .08,
                "roughnessFactor": .07,
            },
            "emissiveFactor": [.13, .018, .18],
            "extensions": {
                "KHR_materials_clearcoat": {"clearcoatFactor": .92, "clearcoatRoughnessFactor": .025},
                "KHR_materials_specular": {"specularFactor": 1.0, "specularColorFactor": [.40, .12, .52]},
                "KHR_materials_emissive_strength": {"emissiveStrength": .55},
        ...
        },
        {
            ...
            "pbrMetallicRoughness": {
                "baseColorFactor": [.26, .78, 1.0, .34],
                "metallicFactor": 0.0,
                "roughnessFactor": .20,
            },
            "emissiveFactor": [.05, .24, .34],
            "alphaMode": "BLEND",
            "extensions": {"KHR_materials_emissive_strength": {"emissiveStrength": .72}},
        },
        {
            "name": "Soft Violet Reflection",
            "pbrMetallicRoughness": {
                "baseColorFactor": [.63, .31, .94, .36],
                "metallicFactor": 0.0,
                "roughnessFactor": .20,
            },
            "emissiveFactor": [.20, .06, .34],
            "alphaMode": "BLEND",
            "extensions": {"KHR_materials_emissive_strength": {"emissiveStrength": .68}},
        },
    ]
    ...
    nodes = [
        ...
        {"name": "Body", "mesh": 0},
        {"name": "Prong_L", "mesh": 1, "translation": [-.305, .835, -.018], "rotation": [0.0, 0.0, -.018, .99984]},
        {"name": "Prong_R", "mesh": 2, "translation": [.305, .835, -.018], "rotation": [0.0, 0.0, .018, .99984]},
        {"name": "ProngBlend_L", "mesh": 3, "translation": [-.305, .625, -.012]},
        {"name": "ProngBlend_R", "mesh": 4, "translation": [.305, .625, -.012]},
        {"name": "Eye_L", "mesh": 5, "translation": [-.285, .015, .292]},
        {"name": "Eye_R", "mesh": 6, "translation": [.285, .015, .292]},
    ...
    gltf = {
        "asset": {"version": "2.0", "generator": "PLUG ART · PLUGY Official V81"},
        "scene": 0,
    ...
    return {
        ...
        "material": "rose-lavender-iridescent",
        "official_base": "V26",
        "profile": "slimmer-plug-integrated-prongs",
    }


if __name__ == "__main__":
    print(build_plugy_official_v81(Path(__file__).resolve().parent / "static" / "plugy_official_v81.glb"))
