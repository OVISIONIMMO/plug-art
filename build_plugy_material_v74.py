    ...
    for material in gltf.get("materials",[]):
        ...
        if "pearl" in name:
            ...
            ext["KHR_materials_specular"]={
                "specularFactor":1.0,
                "specularColorFactor":[1.0,0.965,1.0]
            }
...
def build_plugy_material_v74(output_path):
    pearl=mat((253,253,255),"PLUGY Pearl White",metallic=.018,rough=.042)
    pearl_back=mat((247,246,255),"PLUGY Pearl Back",metallic=.016,rough=.060)
    eye_left=mat((13,70,196),"PLUGY Eye Blue",emissive=(2,18,68),metallic=.10,rough=.025)
    eye_right=mat((37,22,120),"PLUGY Eye Violet",emissive=(10,3,48),metallic=.11,rough=.024)
    ...
    return {
      ...
      "design":"plugy-material-pearl-iridescent-v74",
      "body":False,"material":"pearl-white-clearcoat-iridescence-specular-ior","canonical":True
    }
