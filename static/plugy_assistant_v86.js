...
const anchors={dashboard:[0,0],radar:[-10,-18],opencalls:[-18,-8],studio:[-30,-16],map:[-16,-12],artists:[-20,-10],crm:[-12,-14]};
...
function bindV86Viewer(mv){
  if(!mv||mv.dataset.v86Bound==='1')return;mv.dataset.v86Bound='1';
...
bindV86Viewer(q('#plugyModel'));bindV86Viewer(q('#plugyFloatModel'));
