...
function socialContext(){try{const c=window.PLUGInstagram?.context?.();return c?' Contexte Instagram réel: '+JSON.stringify(c).slice(0,2600)+'. ':''}catch{return''}}
...
function bindV88Viewer(mv){
  if(!mv||mv.dataset.v88Bound==='1')return;mv.dataset.v88Bound='1';
...
bindV88Viewer(q('#plugyModel'));bindV88Viewer(q('#plugyFloatModel'));
})();