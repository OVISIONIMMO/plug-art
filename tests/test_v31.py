...
def test_v30_assets_replace_legacy_plugy_runtimes():
    ...
    assert ('site_v30.js?v=30.20260911.1' in page) or ('site_v32.js?v=32.20260911.1' in page)
    ...
    assert ('window.__PLUG_V30=true' in page) or ('window.__PLUG_V32=true' in page)
