...
def test_v32_assets_in_index_and_no_legacy_runtime():
    ...
    text = page.text
    assert any(x in text for x in ('site_v32.css?v=32.20260911.1','site_v33.css?v=33.20260912.1'))
    assert any(x in text for x in ('site_v32.js?v=32.20260911.1','site_v33.js?v=33.20260912.1'))
