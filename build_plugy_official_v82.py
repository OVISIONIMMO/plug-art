...
def build_plugy_official_v82(output_path: str | Path):
    ...
    prong = superellipsoid(.108, .335, .098, e1=2.45, e2=2.45, n_lat=26, n_lon=52)
    meshes.append(("ProngL", prong, 0))
    meshes.append(("ProngR", prong.copy(), 0))

    # Small blend collars visually fuse the prongs into the head.
    blend = superellipsoid(.145, .095, .125, e1=3.0, e2=3.0, n_lat=18, n_lon=38)
    ...
    eye = tube_chevron(width=.36, height=.145, radius=.049, segments=20, sides=18)
    ...
    materials = [
        {
            "name": "PLUGY Rose Pearl Resin",
            "pbrMetallicRoughness": {
                "baseColorFactor": [1.0, .685, .915, 1.0],
                "metallicFactor": 0.0,
                "roughnessFactor": .115,
            },
            "extensions": {
                "KHR_materials_clearcoat": {"clearcoatFactor": .86, "clearcoatRoughnessFactor": .032},
                "KHR_materials_specular": {"specularFactor": .94, "specularColorFactor": [1.0, .965, 1.0]},
                "KHR_materials_iridescence": {
                    "iridescenceFactor": .58,
                    "iridescenceIor": 1.30,
                    "iridescenceThicknessMinimum": 190.0,
                    "iridescenceThicknessMaximum": 430.0
                },
                "KHR_materials_ior": {"ior": 1.46},
                "KHR_materials_transmission": {"transmissionFactor": .075},
                "KHR_materials_volume": {
                    "thicknessFactor": .18,
                    "attenuationDistance": 2.1,
                    "attenuationColor": [1.0, .72, .93]
                }
            },
        },
        {
            "name": "PLUGY Gloss Black Eyes",
            "pbrMetallicRoughness": {
                "baseColorFactor": [.006, .005, .010, 1.0],
                "metallicFactor": .015,
                "roughnessFactor": .085,
            },
            "extensions": {
                "KHR_materials_clearcoat": {"clearcoatFactor": .94, "clearcoatRoughnessFactor": .022},
                "KHR_materials_specular": {"specularFactor": .98, "specularColorFactor": [.92, .90, 1.0]},
        ...
        },
        {
            ...
            "pbrMetallicRoughness": {
                "baseColorFactor": [.44, .78, 1.0, .14],
                "metallicFactor": 0.0,
                "roughnessFactor": .20,
            },
            "emissiveFactor": [.015, .055, .075],
            "alphaMode": "BLEND",
            "extensions": {"KHR_materials_emissive_strength": {"emissiveStrength": .28}},
        },
        {
            "name": "Soft Violet Reflection",
            "pbrMetallicRoughness": {
                "baseColorFactor": [.68, .42, .95, .15],
                "metallicFactor": 0.0,
                "roughnessFactor": .20,
            },
            "emissiveFactor": [.055, .018, .085],
            "alphaMode": "BLEND",
            "extensions": {"KHR_materials_emissive_strength": {"emissiveStrength": .26}},
        },
    ]
    ...
    nodes = [
        ...
        {"name": "Body", "mesh": 0},
        {"name": "Prong_L", "mesh": 1, "translation": [-.315, .835, -.015], "rotation": [0.0, 0.0, -.018, .99984]},
        {"name": "Prong_R", "mesh": 2, "translation": [.315, .835, -.015], "rotation": [0.0, 0.0, .018, .99984]},
        {"name": "ProngBlend_L", "mesh": 3, "translation": [-.315, .603, -.010]},
        {"name": "ProngBlend_R", "mesh": 4, "translation": [.315, .603, -.010]},
        {"name": "Eye_L", "mesh": 5, "translation": [-.292, -.005, .278]},
        {"name": "Eye_R", "mesh": 6, "translation": [.292, -.005, .278]},
    ...
    gltf = {
        "asset": {"version": "2.0", "generator": "PLUG ART · PLUGY Official V82"},
        "scene": 0,
    ...
    return {
        ...
        "material": "rose-pearl-resin-gloss-black-eyes",
        "official_base": "V26",
        "profile": "reference-matched-wider-flatter-integrated-prongs",
    }


if __name__ == "__main__":
    print(build_plugy_official_v82(Path(__file__).resolve().parent / "static" / "plugy_official_v82.glb"))
